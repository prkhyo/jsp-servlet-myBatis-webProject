...
public class BoardBean {
	...
	private int BOARD_AVAILABLE; //삭제되지않은 글일 경우1, 삭제된 경우0 
	...
	public String toString() {
		return "BoardBean [BOARD_NUM=" + BOARD_NUM + ", BOARD_USERID=" + BOARD_USERID + ", BOARD_TITLE=" + BOARD_TITLE
				...
				+ BOARD_READCOUNT + ", BOARD_DATE=" + BOARD_DATE + ", BOARD_AVAILABLE=" + BOARD_AVAILABLE + "]";
	}
